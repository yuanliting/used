...
//var tb_room = require('./gamemgr_tb_coins');
var io = null;
//血流成河,血战到底的房间
exports.start = function(config,mgr){
	console.log('进入普通房间的双向数据通讯中' + config.CLIENT_PORT)
...
//			console.log(sign);
			...
			console.log('通过token获取用户id + ' + userId);
...
//			console.log(roomInfo)
	...
	console.log("普通麻将game server is listening on " + config.CLIENT_PORT);	
};
